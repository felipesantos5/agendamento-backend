...
export default function StepIndicator({ currentStep, totalSteps }: StepIndicatorProps) {
  const steps = [
    { number: 1, title: "Service & Stylist" },
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute left-0 top-4 h-0.5 w-full bg-gray-200">
        <div
          className="h-0.5 bg-rose-500 transition-all duration-300"
      ...
      <div className="relative flex justify-between">
        {steps.map((step) => (
          <div key={step.number} className="flex flex-col items-center">
            <div
              className={`flex h-8 w-8 items-center justify-center rounded-full border-2 ${step.number === currentStep
